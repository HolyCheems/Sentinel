    ...
    constructor(lot, canvas) {
        super(lot, canvas, (self, ctx, annotation) => {
            ...
            switch (annotation.Type) {
                case 'Standard': ctx.fillStyle = 'rgba(0,255,0,0.3)'; break;//red
                case 'Aisle': ctx.fillStyle = 'rgba(187,0,255,0.2)'; break;//dark blue
